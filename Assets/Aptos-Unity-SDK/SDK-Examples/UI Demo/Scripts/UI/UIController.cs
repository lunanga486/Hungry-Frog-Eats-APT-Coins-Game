...
namespace Aptos.Unity.Sample.UI
{
    public class UIController : MonoBehaviour
    {
        ...
        [SerializeField] private PanelTab nftShopTab;
        [SerializeField] private PanelTab playTab;
        ...
        public void ToggleEmptyState(bool _empty)
        {
            ...
            nftShopTab.DeActive(_empty);
            playTab.DeActive(_empty);
        ...
        public void BuyNFT(int index)
        {
            StartCoroutine(AptosUILink.Instance.BuyVIPNFT(index, false));
        }

        public void RefreshNFT()
        {
            StartCoroutine(AptosUILink.Instance.BuyVIPNFT(1, true));
            StartCoroutine(AptosUILink.Instance.BuyVIPNFT(2, true));
            StartCoroutine(AptosUILink.Instance.BuyVIPNFT(3, true));
            StartCoroutine(AptosUILink.Instance.BuyVIPNFT(4, true));
            StartCoroutine(AptosUILink.Instance.BuyVIPNFT(5, true));
            StartCoroutine(AptosUILink.Instance.BuyVIPNFT(6, true));
            StartCoroutine(AptosUILink.Instance.BuyVIPNFT(7, true));
        }
        public void BuyHeart()
        {
            StartCoroutine(AptosUILink.Instance.BuyMoreHearth());
        }
